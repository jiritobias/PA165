...
public class MainJavaSe {
	...
	private static void task04() {
		...
		createCategory(em, "Electronics");
		createCategory(em, "Musical");
	...
	private static void commitAndClose(EntityManager entityManager) {
	...
	private static void createCategory(EntityManager em, String categoryName) {
		assert em != null;
	...
	private static void task06() {
		...
		p1.setAddedDate(addedDate.getTime());
